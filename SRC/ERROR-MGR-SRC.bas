...
50013 REM   STOPS EXECUTION ( IF ERROR_MGR_STOP CALLED )
50014 REM   ENDS EXECUTION ( IF ERROR_MGR_END CALLED )

50100 REM === PUBLIC INTERFACES ===
50110 GOSUB 50210 : RETURN : REM ERROR_MGR_INIT
50120 GOSUB 50310 : RETURN : REM ERROR_MGR_SHOW
50130 GOSUB 50410 : RETURN : REM ERROR_MGR_STOP
50140 GOSUB 50510 : RETURN : REM ERROR_MGR_END

50200 REM === ERROR_MGR_INIT
50210 ER%=0 : ER$="" : REM ERROR CODE, ERROR STRING
50220 EL%=0 : EM$="" : REM LINE NUM, MODULE NAME
50230 RETURN

50300 REM === ERROR_MGR_SHOW
50310 LOCATE 1,1 : UPPER LEFT CORNER
50320 COLOR 2,0  : REM RED ON BLACK
50330 PRINT " ERROR: ";ER%;" '";ER$;"' : AT LINE ";EL%;" IN ";EM$;" " 
50340 RETURN

50400 REM === ERROR_MGR_STOP
50410 GOSUB 50120 : STOP : RETURN

50500 REM === ERROR_MGR_END
