...
This phase lays the astrophysical and resource foundation before the later **civilization expansion** generator adds inhabited worlds, space stations, industrial sites, and human/civil names.
...
- Stage 0 → Star systems (`star_catalog.csv`)  
- **Stage 1 → Natural celestial objects (this script → `system_objects.csv`)**  
- Stage 2 → Civilization expansion (colonies, stations, industrial sites)  
